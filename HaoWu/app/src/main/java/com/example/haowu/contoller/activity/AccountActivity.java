...
public class AccountActivity extends AppCompatActivity {
    ...
    //定义TextView的变量
    private TextView tv_account_state,tv_account_gprice,tv_account_userdata,tv_account_allprice,tv_account_gallprice,tv_account_chat,
    ...
    private void initView(){
        ...
        tv_account_chat = (TextView)findViewById(R.id.tv_account_chat);
        ...
        tv_account_chat.setOnClickListener(listener);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.ll_account_goods:
                    ...
                    break;
                //聊天按键
                case R.id.tv_account_chat:
                    userChat(uagdata.get("hxid").toString());
                    break;
                //取消订单
    ...
    private void userChat(String hxid){
        ...
        if(UserUtils.getCurrentUser().getHxId().trim().equals(hxid)){
            Toast.makeText(AccountActivity.this, "不能跟自己聊天！", Toast.LENGTH_SHORT).show();
        }else {
