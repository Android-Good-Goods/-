...
import com.example.haowu.contoller.adapter.BuylistAdapter;
import com.example.haowu.contoller.adapter.GoodslistAdapter;
                            ...
                            if(goodsBack == 1){
                                ...
                                lv_goodslist_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> adapterView, View view, int position,
                                                            long id) {
                                        //跳转到商品详情页面
                                        Intent intent = new Intent(view.getContext(), com.myapp.qutaomarket.contoller.activity.GoodsdetailActivity.class);
