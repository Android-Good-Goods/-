...
import com.example.haowu.contoller.adapter.ConmentslistAdapter;
import com.example.haowu.model.Model;
import com.example.haowu.model.db.User;
import com.example.haowu.utils.HttpUtils;
import com.example.haowu.utils.RoundTransform;
import com.example.haowu.utils.SetViewHeight;
...
public class BuydetailActivity extends AppCompatActivity {
    ...
    //定义ImageView变量
    private ImageView iv_buydetail_back,iv_buydetail_headphoto,iv_buydetail_tel,iv_buydetail_image;
    ...
    private TextView tv_buydetail_title,tv_buydetail_nickname,tv_buydetail_repu,tv_buydetail_bname,tv_buydetail_sprice,tv_buydetail_bprice,
            tv_buydetail_bgetway,tv_buydetail_bhownew,tv_buydetail_btype,tv_buydetail_bcontent,tv_buydetail_bcity,tv_buydetail_bnumber,
    ...
    private void initView(){
        ...
        iv_buydetail_tel = (ImageView)findViewById(R.id.iv_buydetail_tel);
        iv_buydetail_image = (ImageView)findViewById(R.id.iv_buydetail_image);
        //TextView
        ...
        ll_buydetail_chat.setOnClickListener(listener);
    ...
    private void initData(){
        ...
        //长按删除评论，私信回复
        lv_buydetail_comments.setOnCreateContextMenuListener(new View.OnCreateContextMenuListener() {
            @Override
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.iv_buydetail_back:
                    ...
                    break;
                //电话按键
                case R.id.iv_buydetail_tel:
                    userCall(uagdata.get("tel").toString());
                    break;
                //聊天按键
                case R.id.ll_buydetail_chat:
    ...
    private void userChat(String hxid){
        if(UserUtils.getCurrentUser().getHxId().trim().equals(hxid)){
            Toast.makeText(BuydetailActivity.this, "不能跟自己聊天！", Toast.LENGTH_SHORT).show();
        }else {
            Intent intent = new Intent(BuydetailActivity.this, ChatActivity.class);
            //传递参数
    ...
    public boolean onContextItemSelected(MenuItem item){
        ...
        switch (item.getItemId()){
            case 0:           //删除评论
                ...
                }else Toast.makeText(BuydetailActivity.this, "您不能删除该评论！", Toast.LENGTH_SHORT).show();
                break;
            case 1:          //私信
