...
import com.myapp.haowu.QTApplication;
import com.myapp.haowu.R;
import com.myapp.haowu.contoller.activity.MybuyActivity;
import com.myapp.haowu.contoller.activity.MycharityActivity;
import com.myapp.haowu.contoller.activity.MycollectActivity;
import com.myapp.haowu.contoller.activity.MyfreeActivity;
import com.myapp.haowu.contoller.activity.MyoutActivity;
import com.myapp.haowu.contoller.activity.MypublishActivity;
import com.myapp.haowu.contoller.activity.PersonActivity;
import com.myapp.haowu.contoller.activity.SettingActivity;
        ...
        public void onClick(View v) {
            switch(v.getId()){
                ...
                case R.id.rl_f5_person:
                    ...
                    break;
                    //免费送
                case R.id.rl_f5_free:
                    Intent intent_free = new Intent(getActivity(), MyfreeActivity.class);
                    startActivity(intent_free);
                    break;
                    //我的公益
                case R.id.rl_f5_charity:
                    Intent intent_charity = new Intent(getActivity(), MycharityActivity.class);
                    startActivity(intent_charity);
                    break;
                    //设置
